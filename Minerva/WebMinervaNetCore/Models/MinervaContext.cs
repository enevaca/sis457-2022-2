...
public partial class MinervaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Compra__3213E83F5E961543");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CompraDe__3213E83F784DCE26");
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.CompraDetalles)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_ComprarDetalle_Producto");
        });

        modelBuilder.Entity<Empleado>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Empleado__3213E83F9423DC7C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producto__3213E83F69633341");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Proveedo__3213E83FC5E5987F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Usuario__3213E83FB6BCFE23");
